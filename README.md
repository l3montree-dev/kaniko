...
1. Add an environment variable `STACKLOG_PATH` to your
   [pod definition](https://github.com/chainguard-dev/kaniko/blob/master/examples/pod-build-profile.yaml#L15).
...
2. Kaniko needs to be able to run on the desired architectures. At the time of
   ...
   [linux/amd64, linux/arm64, linux/s390x and linux/ppc64le (not on \*-debug images)](https://github.com/chainguard-dev/kaniko/blob/main/.github/workflows/images.yaml).
...
occur, please
[open an issue](https://github.com/chainguard-dev/kaniko/issues)._
